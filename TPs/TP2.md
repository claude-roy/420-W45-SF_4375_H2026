...
- Inscrire les commandes utilisées pour la création des conteneurs, les commandes et les résultats des commandes pour vérifier :
...
- Dans le fichier `README.md` du répertoire `mon_drupal`, vous devez inclure une image d'une capture d’écran démontrant votre drupal avec le thème Bootstrap 3 d'installé, les commandes utilisées pour créer et lancer le conteneur. 
