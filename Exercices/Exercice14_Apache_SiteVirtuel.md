...
### Étape 2 : PHP et MariaDB avec Apache  
...
<details>
<summary>Modification du fichier Dockerfile.</summary>  
...
# Ajoute le répertoire pour site01
...
# Change dans le répertoire de configuration
...
<details>  
<summary>Modification du fichier <code>compose.yaml</code>.</summary>  
...
<details>
<summary>Modification du fichier <code>httpd-vhosts-conf</code>.</summary>   
...
services:
    apache:
        ...
        volumes:
                - ./site01/html/:/usr/local/apache2/site01.com/
                - ./log/apache2/:/usr/local/apache2/logs/    
 ```
