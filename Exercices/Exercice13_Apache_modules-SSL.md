...
#### Syntaxe du fichier compose.yaml  
...
Lancez votre conteneur et vérifiez que ça fonctionne en allant au site Web [http://www.monsite.com:8080](http://www.monsite.com:8080).

La commande pour lancer le conteur est :  
...
<summary>Explication détaillée du fichier <code>compose.yaml</code>.</summary>
...
- build : L'image Docker pour ce service est construite à partir du répertoire ```./php/```, qui contient le fichier Dockerfile pour l'application PHP.
...
La mise en place des réseaux permet aussi la résolution de nom.
...
- Allez à la page du site sur votre navigateur. Puis, allez à la page [http://www.monsite.com:8080/info.php](http://www.monsite.com:8080/info.php).  
...
-	Lancer (utiliser l’option ```--build```) et vérifier que votre serveur est bien lancé et utilise maintenant https. (Utiliser [https://www.monsite.com](https://www.monsite.com), car nous n’avons pas encore de serveur virtuel).

- Est-ce que votre site Web fonctionne avec SSL ? 

<details>
<summary>Réponse</summary>
Oui, mais nous avons l’erreur : You don't have permission to access / on this server. Ou, il n'y a rien qui s'affiche (page blanche).
</details>
<br>  
...
Est-ce que votre site Web fonctionne avec SSL maintenant (utiliser [https://www.monsite.com](https://www.monsite.com))?  
Oui.
