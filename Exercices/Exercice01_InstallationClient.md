...
<details>
	...
	La deuxième commande ne s’exécutera que si la première commande s’est exécutée avec succès, c’est-à-dire si son code de sortie est zéro. Cet opérateur peut être utilisé pour vérifier si la première commande s’est exécutée correctement. C’est l’une des commandes les plus utilisées en ligne de commande.  
...
<details>
	<summary markdown="span">Réponse :</summary>
	<code>apt update</code> : met à jour la liste des paquets disponibles à partir des dépôts configurés dans /etc/apt/sources.list. <br>  
